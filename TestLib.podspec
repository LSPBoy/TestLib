...
Pod::Spec.new do |spec|
  ...
  spec.description  = "testLib 这个是详细描述，一定要注意字数要比spec.summary长"
  ...
  spec.author             = { "liji" => "liji@123.com" }
  # Or just: spec.author    = "liji"
  # spec.authors            = { "liji" => "liji@123.com" }
  # spec.social_media_url   = "https://twitter.com/liji"
